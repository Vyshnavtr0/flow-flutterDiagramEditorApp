...
import 'package:flow/simple_diagram_editor/data/custom_link_data.dart';
import 'package:flow/simple_diagram_editor/dialog/pick_color_dialog.dart';
                    ...
                    children: [
                      DropdownButton<ArrowType>(
                        ...
                        onChanged: (ArrowType? newValue) {
                          if (newValue != null)
                            setState(() => arrowTypeDropdown = newValue);
                        },
                  ...
                  child: Column(
                    ...
                    children: [
                      DropdownButton<ArrowType>(
                        ...
                        onChanged: (ArrowType? newValue) {
                          if (newValue != null)
                            setState(() => backArrowTypeDropdown = newValue);
                        },
                        items: ArrowType.values.map((ArrowType arrowType) {
                          return DropdownMenuItem<ArrowType>(
                            value: arrowType,
